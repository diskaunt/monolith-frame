      ...
      >
        <div
          className={classNames(
            ...
            'uppercase bg-white text-black w-[394px] h-[410px] pt-[31px] pl-[23px] text-[34px] leading-[25px] tracking-normal text-[34px] space-y-[30px] transition-all duration-300'
          )}
        >
