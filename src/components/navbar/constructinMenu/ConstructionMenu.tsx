  ...
  return (
    <div
      className={classNames(
        ...
        'trasition-all w-full grow overflow-hidden shadow-lg',
      )}
    >
      <div
        className={classNames(
          ...
          // projectPath ? 'hd:w-menuDevProject' : 'hd:w-max',
          'flex w-full min-w-[360px] flex-nowrap justify-between gap-[10px] bg-white p-[10px] text-black transition-all duration-300 h-[410px] fhd:max-w-[1150px]',
        )}
      >
        {/* Список проектов */}
        ...
        {/* Изображение проекта */}
        <div className="hidden h-full w-[450px] overflow-hidden pt-[2px] hd:block">
          <Image
