      ...
      <div className="relative m-auto w-full max-w-[375px] hd:max-w-[1558px]">
        ...
        <div className="absolute left-[-7%] top-[566px] z-0 hd:left-[2%] hd:top-[638px] fhd:left-0">
          <div className="flex w-[375px] justify-center hd:w-[1558px] fhd:pl-[4%]">
            <Illustration name="aboutUsRoadMap" />
          </div>
        </div>
        ...
        <div className="relative w-full">
          ...
          >
            ...
            >
              <AboutUsAchvmts styles={styles} number={20}>
                <p className={classNames('max-w-[179px] hd:ml-[-40px] hd:max-w-[359px]')}>
            ...
            <div className="mr-[20px] self-end hd:ml-0 hd:mt-[75px]">
              ...
              >
                <div
                  className={classNames(styles.loadImage, 'w-[155px] shrink-0 hd:min-w-[258px]')}
                >
                  <Image
          ...
          {/* опыт */}
          <div ref={setScrollVerticalRefs} className="flex flex-col gap-y-[100px] hd:gap-y-[240px]">
            ...
            >
              <div className={classNames(styles.loadImage, 'z-10 w-[185px] hd:w-fit')}>
                <Image
                  className="w-full object-cover hd:object-none"
          ...
          <div ref={setDivLoadRef} className="invisible w-full">
            <div ref={setScrollVerticalRefs} className="flex w-full flex-col hd:gap-y-[110px]">
              {/* Скорость */}
              <div
                className={classNames(
          ...
          <div className="h-100svh w-full hd:mb-[80px]" ref={setScrollVerticalRefs}>
            <div
              ref={setDivLoadRef}
              className={classNames(
            ...
            >
              ...
              {/* Надежность */}
              <div className="flex flex-wrap hd:grow">
                <div
                  className={classNames(
