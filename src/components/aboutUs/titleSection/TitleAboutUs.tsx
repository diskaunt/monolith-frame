...
const TitleAboutUs = ({
  ...
  const snowMountTopRef = useRef<HTMLDivElement>(null),
    ...
    [divLoadRefs2, setDivLoadRef2] = useObserver(
      (entryes) => {
    ...
    [divLoadRefs3, setDivLoadRef3] = useObserver(
      (entryes) => {
        entryes.forEach((entry: IntersectionObserverEntry) => {
          if (entry.isIntersecting) {
  ...
  return (
    <>
      <div className="relative w-full bg-blue-500">
        ...
        <div ref={setScrollVerticalRefs} className="hidden h-100svh w-full hd:block">
          <div className="h-[60svh] w-full bg-white">
            <div
              ref={setBlackThemeRefs}
              className={classNames(
                'z-10 mx-auto flex h-full w-full max-w-[1920px] flex-wrap gap-x-[206px] overflow-hidden px-[20px] py-[33px]',
              )}
            >
              <div ref={setDivLoadRef} className="invisible mt-[120px]">
                <SecTitle titleLoad={styles.titleLoad} arrowLoad={styles.arrowLoad} color="black">
                  о компании
                </SecTitle>
              </div>
              <div
                ref={setDivLoadRef}
                className={classNames(styles.descrLoad, 'invisible w-[589px] self-end')}
              >
                <p className="font-inter text-[28px] leading-[35px] tracking-veryTight">
                  Наша история – летопись непрерывного роста масштабов реализуемых проектов,
                  расширения направлений профессиональной деятельности и географии возведённых
                  объектов.
                </p>
              </div>
            </div>
        ...
        {/*Верхние вершины гор */}
        <div className="hidden w-full hd:sticky hd:top-[100svh] hd:block">
          <div
            ref={snowMountTopRef}
            className={classNames(
          ...
          >
            <Illustration name="aboutUsStart" />
          </div>
        </div>

        {/* Основная секция с текстом*/}
        <div ref={setScrollVerticalRefs} className="flex h-[100svh] w-full flex-col bg-blue-500">
          <div
          ...
          >
            ...
            >
              <div className={classNames('ml-[25px] mt-[112px] hd:ml-[15%] hd:mt-[10%]')}>
                <div ref={setDivLoadRef} className="invisible inline-block overflow-hidden">
                  <p
                    className={classNames(
                      styles.titleLoad,
              ...
              >
                <div>
                  <p className="hd:tracking-veryTigth font-inter text-[15px] font-medium leading-[20px] tracking-tight2 hd:text-[19px] hd:leading-[26px]">
                    ...
                    Приволжского федерального округа, Московской области и&nbsp;Владимирской
                    области.
                  </p>
                </div>
              </div>
              ...
              <div className={classNames('ml-[5%] mt-[0px] hd:ml-[46.5%] hd:mt-[6px]')}>
                <div ref={setDivLoadRef} className="invisible inline-block overflow-hidden">
                  <p
                    className={classNames(
                      styles.titleLoad,
      ...
      {/* небоскреб */}
      <div className={classNames('relative bottom-[585px] top-[0px] z-10 w-full')}>
        <div
          ref={whiteTowerRef}
          className={classNames(
        ...
        >
          <Image
            className="mx-auto h-auto w-[256px] sm:w-[40%] hd:w-[41%]"
      ...
      >
        <div ref={setDivLoadRef3} className="h-full w-full">
          <div
            ref={setWhiteThemeRefs}
            className="relative h-full min-h-[558px] w-full hd:min-h-[1209px]"
          >
            <Image
      ...
      {/* Нижние вершины гор */}
      <div className="absolute -bottom-1 left-0 z-10 h-[142px] w-full overflow-hidden fill-white hd:h-[20svh] hd:w-full">
        <Illustration name="aboutUsMid" />
      </div>
    </>
  );
};
